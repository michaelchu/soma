...
import type { BPCategory, BPThresholds, BPReferenceLine } from '@/types';
...
export const BP_THRESHOLDS: BPThresholds = {
  systolic: {
    normal: { max: 119 },
...
export const BP_REFERENCE_LINES: { systolic: BPReferenceLine[]; diastolic: BPReferenceLine[] } = {
  systolic: [
